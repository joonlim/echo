...
public class WebhookEventMonitor extends TriggerMonitor {
  ...
  protected Function<Trigger, Pipeline> buildTrigger(Pipeline pipeline, TriggerEvent event) {
    ...
    String triggerCorrelationId = (String) content.get("triggerCorrelationId");
    ...
    return trigger -> pipeline
        ...
        .withTrigger(trigger.atParameters(parameters).atPayload(payload).atTriggerCorrelationId(triggerCorrelationId));
  }
